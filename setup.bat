...
REM STEP 1: CHECK AND INSTALL PYENV
...
REM Check the exit code from PowerShell (10 means pyenv was installed)
if %ERRORLEVEL%==10 (
    set RESTART_REQUIRED=1
)

REM STEP 1B: RESTART IF REQUIRED
...
REM STEP 2: INSTALL PYTHON 3.10.11 USING PYENV
